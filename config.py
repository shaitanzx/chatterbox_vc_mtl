...
DEFAULT_RUACCENT_CACHE_PATH = Path("./ruaccent_cache")
...
DEFAULT_CONFIG: Dict[str, Any] = {
    "server": {
        "host": "127.0.0.1",  # Host address for the server to listen on.
    ...
    "paths": {  # General configurable paths for the application.
        ...
        "ruaccent_cache": str(Path("./ruaccent_cache")),
        "output": str(
            DEFAULT_OUTPUT_PATH
    ...
    "generation_defaults": {  # Default parameters for TTS audio generation.
        "temperature": 0.01,  # Controls randomness: lower is more deterministic.
        "exaggeration": 1.0,  # Controls expressiveness or exaggeration in speech.
        "cfg_weight": 0.0,  # Classifier-Free Guidance weight, influences adherence to prompt/style.
    ...
    "audio_output": {  # Settings related to the format of generated audio.
        ...
        "max_reference_duration_sec": 120,  # Maximum duration for reference audio files.
    },
    "ui_state": {  # Stores user interface preferences and last-used values.
        ...
        "last_chunk_size": 280,  # Last used chunk size for text splitting in UI.
    ...
    "ui": {  # General UI display settings.
        ...
        "max_predefined_voices_in_dropdown": 24,  # Max predefined voices to list in UI dropdown.
    },
...
def get_ruaccent_cache_path(ensure_absolute: bool = True) -> Path:
    """Returns the path to the ruaccent model cache directory."""
    default_path_str = str(DEFAULT_RUACCENT_CACHE_PATH)  # ← используйте переменную
    return config_manager.get_path(
        "paths.ruaccent_cache", 
        default_path_str, 
        ensure_absolute=ensure_absolute
    )
