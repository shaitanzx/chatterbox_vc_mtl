...
def create_gradio_interface():
    ...
    with gr.Blocks(title="Chatterbox Server",theme=gr.themes.Base()) as demo:
        ...
        gr.HTML('* Repack by Shahmatist^RMDA. Based on repacks by <a href="https://huggingface.co/datasets/LeeAeron/Chatterbox-TTS-Server-Multilingual" target="_blank">LeeAeron</a>, <a href="https://github.com/petermg/Chatterbox-TTS-Extended" target="_blank"> petermg</a> and <a href="https://github.com/resemble-ai/chatterbox" target="_blank">resemble-ai</a><\p> * Disclaimer: All voice examples are taken from open sources and are presented with respect to their users and for demonstration purposes only. For commercial use, we recommend contacting the authors. Unauthorized use of other people\'s voices for commercial purposes and without permission not only violates the rights of their owners but may also be prosecuted. We strictly prohibit, condemn, and assume no liability for the use of this technology to violate anyone\'s rights or commit illegal acts!<\p>* All suggestions and questions can be voiced in the <a href="https://t.me/+xlhhGmrz9SlmYzg6" target="_blank">Telegram-groupn</a>')
